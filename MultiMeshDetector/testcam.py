...
while True:
    ...
    if results5.multi_hand_landmarks:
        for handLms in results5.multi_hand_landmarks:
            mpDraw.draw_landmarks(img, handLms, mpHands.HAND_CONNECTIONS,mpDraw.DrawingSpec(color=(0, 250, 0)),mpDraw.DrawingSpec(color=(0, 250, 0)))
